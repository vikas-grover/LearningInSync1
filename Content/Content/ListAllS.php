...
<p></p>
 ...
 <?php
	...
	if (isset($_POST['findcontent'])) {
	$school_id = $_POST['schoolid'];  // take posted country code
  ...
  $query = "Select subject_code, termid, gradeid, schoolid, FileID, name, size from content where schoolid = $school_id";
